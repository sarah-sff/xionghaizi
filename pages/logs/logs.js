...
Page({
  data: {
    logs: [],
    behaviors: [{ thing: 1, score: 1 }, { thing: 2, score: 3 }, { thing: 3, score: 2 }, { thing: 4, score: 0 }, { thing: 5, score: 0 }],
    things: ['早餐', '中餐', '晚餐', '睡觉', '看书'],
    card_class: [{ score_class: 'undo', icon_type: 'waiting', desc: '未做' }, { score_class: 'unsatisfied', icon_type: 'warn', desc: '差' }, { score_class: 'ordinary', icon_type: 'info', desc: '一般' }, { score_class: 'good', icon_type: 'success', desc: '很好'  }]
  },
  //事件处理函数
